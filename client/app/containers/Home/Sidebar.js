    ...
    render() {
        return (
            <div className="sidenav">
                    <NavLink to='/' title="hello world"><i class="material-icons"> dashboard</i>  </NavLink>
                    <NavLink to='/dashboard' title="dashboard"><i class="material-icons">home</i></NavLink>
                    <NavLink to='/home' title="hello world"><i class="material-icons">work</i></NavLink>
